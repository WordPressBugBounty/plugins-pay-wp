			...
			<table class="form-table" id="wppay-accounts">
				...
				<tr>
					<td>
						...
						<p><?php printf( __( 'You will receive your credentials by email after registration or you will find them in the %sadministration panel%s.', 'pay-wp' ), '<a href="https://wpdesk.link/wppay-plugin-panel" target="_blank">', '</a>' ); ?></p>
					</td>
				</tr>
				<tr>
					<td>
