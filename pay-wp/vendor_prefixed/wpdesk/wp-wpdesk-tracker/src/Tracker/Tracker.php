...
final class Tracker
{
    ...
    private function register_hooks()
    {
        ...
        add_action('admin_init', [\WPPayVendor\WPDesk_Tracker::class, 'schedule']);
    ...
    public function send_scheduled_tracking_data()
    {
        ...
        if ($tracker instanceof \WPPayVendor\WPDesk_Tracker) {
    ...
    private function get_tracker()
    {
        ...
        if (!is_object($tracker)) {
            $factory = new \WPPayVendor\WPDesk_Tracker_Factory_Prefixed($this->logger);
