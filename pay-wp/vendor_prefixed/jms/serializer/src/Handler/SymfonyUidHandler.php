...
final class SymfonyUidHandler implements SubscribingHandlerInterface
{
    ...
    private const UID_CLASSES = [Ulid::class, Uuid::class, UuidV1::class, UuidV3::class, UuidV4::class, UuidV5::class, UuidV6::class, UuidV7::class, UuidV8::class];
    /**
     * @var string
    ...
    public static function getSubscribingMethods(): array
    {
        ...
        foreach ($formats as $format) {
            foreach (self::UID_CLASSES as $class) {
                $methods[] = ['direction' => GraphNavigatorInterface::DIRECTION_SERIALIZATION, 'format' => $format, 'type' => $class, 'method' => 'serializeUid'];
                $methods[] = ['direction' => GraphNavigatorInterface::DIRECTION_DESERIALIZATION, 'format' => $format, 'type' => $class, 'method' => 'deserializeUidFrom' . ucfirst($format)];
            }
        }
        return $methods;
    }
