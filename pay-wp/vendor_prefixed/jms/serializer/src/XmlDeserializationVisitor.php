    ...
    public function prepare($data)
    {
        ...
        if (\false !== stripos($data, '<!doctype')) {
            ...
            if (!in_array($internalSubset, $this->doctypeAllowList, \true)) {
                throw new InvalidArgumentException(sprintf('The document type "%s" is not allowed. If it is safe, you may add it to the allowlist configuration.', $internalSubset));
            }
        }
