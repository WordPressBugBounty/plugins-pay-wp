...
use WPPayVendor\JMS\Serializer\Handler\UnionHandler;
...
final class SerializerBuilder
{
    ...
    {
        $this->serializationVisitorsAdded = \true;
        $this->serializationVisitors = ['xml' => new XmlSerializationVisitorFactory(), 'json' => new JsonSerializationVisitorFactory()];
        return $this;
    }
    public function addDefaultDeserializationVisitors(): self
    {
        $this->deserializationVisitorsAdded = \true;
        $this->deserializationVisitors = ['xml' => new XmlDeserializationVisitorFactory(), 'json' => new JsonDeserializationVisitorFactory()];
        return $this;
    }
    /**
    ...
    public function build(): Serializer
    {
        ...
        if (null === $this->driverFactory) {
            ...
            $this->driverFactory = new DefaultDriverFactory($this->propertyNamingStrategy, $this->typeParser, $this->expressionEvaluator instanceof CompilableExpressionEvaluatorInterface ? $this->expressionEvaluator : null);
        ...
        $navigatorFactories = [GraphNavigatorInterface::DIRECTION_SERIALIZATION => $this->getSerializationNavigatorFactory($metadataFactory), GraphNavigatorInterface::DIRECTION_DESERIALIZATION => $this->getDeserializationNavigatorFactory($metadataFactory)];
        return new Serializer($metadataFactory, $navigatorFactories, $this->serializationVisitors, $this->deserializationVisitors, $this->serializationContextFactory, $this->deserializationContextFactory, $this->typeParser);
    }
    ...
    {
        return new SerializationGraphNavigatorFactory($metadataFactory, $this->handlerRegistry, $this->getAccessorStrategy(), $this->eventDispatcher, $this->expressionEvaluator);
    }
    ...
    {
        return new DeserializationGraphNavigatorFactory($metadataFactory, $this->handlerRegistry, $this->objectConstructor ?: new UnserializeObjectConstructor(), $this->getAccessorStrategy(), $this->eventDispatcher, $this->expressionEvaluator);
    }
