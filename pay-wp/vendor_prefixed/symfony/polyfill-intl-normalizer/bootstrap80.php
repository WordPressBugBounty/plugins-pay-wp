...
if (!\function_exists('normalizer_is_normalized') && !\function_exists('WPPayVendor\normalizer_is_normalized')) {
...
if (!\function_exists('normalizer_normalize') && !\function_exists('WPPayVendor\normalizer_normalize')) {
...
if (!\function_exists('normalizer_get_raw_decomposition') && !\function_exists('WPPayVendor\normalizer_get_raw_decomposition')) {
