...
if (!\class_exists('ValueError', \false)) {
    ...
    \class_alias('WPPayVendor\ValueError', 'ValueError', \false);
}
...
if (!\function_exists('grapheme_extract') && !\function_exists('WPPayVendor\grapheme_extract')) {
...
if (!\function_exists('grapheme_stristr') && !\function_exists('WPPayVendor\grapheme_stristr')) {
...
if (!\function_exists('grapheme_strlen') && !\function_exists('WPPayVendor\grapheme_strlen')) {
    function grapheme_strlen($input)
    {
        return p\Grapheme::grapheme_strlen($input);
    }
}
if (!\function_exists('grapheme_strpos') && !\function_exists('WPPayVendor\grapheme_strpos')) {
    function grapheme_strpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strripos') && !\function_exists('WPPayVendor\grapheme_strripos')) {
    function grapheme_strripos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strripos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strrpos') && !\function_exists('WPPayVendor\grapheme_strrpos')) {
    function grapheme_strrpos($haystack, $needle, $offset = 0)
    {
        return p\Grapheme::grapheme_strrpos($haystack, $needle, $offset);
    }
}
if (!\function_exists('grapheme_strstr') && !\function_exists('WPPayVendor\grapheme_strstr')) {
...
if (!\function_exists('grapheme_substr') && !\function_exists('WPPayVendor\grapheme_substr')) {
